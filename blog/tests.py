...
class TestView(TestCase):
    ...
    def test_comment_form(self):
        ...
        self.assertIn('john1', new_comment_div.text)
        self.assertIn('john1의 댓글입니다', new_comment_div.text)
        
    def test_comment_update(self):
        comment_by_john2 = Comment.objects.create(
            post=self.post_001,
            author=self.user_john2,
            content='내 댓글이다!',
        )
        ...
        self.assertEqual(response.status_code, 200)
        comments_area = soup.find('div', id='comment-area')
        comment_001_div = comments_area.find('div', id='comment-1')
        self.assertIn('댓글을 수정합니다', comment_001_div.text)
    ...
    def test_delete_comment(self):
        ...
        self.assertIn(self.post_001.title, soup.title.text)
        comment_area = soup.find('div', id='comment-area')
        self.assertNotIn('내 댓글이다', comment_area.text)
